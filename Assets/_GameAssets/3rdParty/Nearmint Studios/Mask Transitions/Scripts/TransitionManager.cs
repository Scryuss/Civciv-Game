...
[Tooltip("Maskenin ekranı kaplaması için ne kadar büyüyeceğini belirler. Yetmezse artırın (Örn: 2, 3, 5).")]
public float sizeMultiplier = 1.5f; 
// ... (diğer değişkenlerin durmaya devam etsin)
    ...
    // Ekranın en uzun kenarını al ve senin belirlediğin çarpanla çarp
    maxSize = Mathf.Max(screenWidth, screenHeight) * sizeMultiplier;
        }
